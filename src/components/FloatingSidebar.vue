    ...
    <div class="row justify-content-start">
        <div class="col-3">
            ...
            <div class="btn-center mt-4 size-4">
                <svg @click="openComponent('addNewEvent')" type="button" width="100px" height="100px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="btn-center mt-4 size-4">
                <svg @click="openComponent('pastEvents')" type="button" width="100px" height="100px" viewBox="0 0 1024 1024" fill="#000000" class="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg">
